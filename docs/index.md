...
The AI Software Template that was executed comes with a sample application. This application will be built from https://github.com/fpetk-rolling-demo/rag-test1, stored in [quay.io/tpetkos/rag-test1](https://quay.io/tpetkos/rag-test1) and deployed through ArgoCD. 
